...
export default function ImageUpload({
  ...
  const handleFile = useCallback(
    ...
    [preview, onFileSelect, validateFile]
  );
  ...
  return (
    <div className="w-full h-full">
      ...
      <label
        ...
        onDrop={handleDrop}
        className={`border-2 border-dashed rounded-lg p-2 w-full h-full bg-white shadow-md flex flex-col justify-center text-center cursor-pointer transition-colors duration-200 ${
          isDragging
